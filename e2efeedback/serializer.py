...
class FeedBackSerializer(serializers.Serializer):
	...
	tellmedaveOutput= drf.ListField(serializers.CharField(),required=True)
	...
	tellmedaveFeedbackText = drf.ListField(drf.ListField(serializers.CharField()),required=False)
	planitFeedbackText = drf.ListField(drf.DictField(serializers.CharField()),required=False)
	
	tellmedaveFeedback = drf.ListField(serializers.CharField(),required=False)
	planitFeedback = drf.ListField(serializers.CharField(),required=False)
